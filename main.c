...
static void	initialize(t_game *game)
{
	...
	game->s_tex = mlx_xpm_file_to_image(game->mlx, game->s_texture, &size, &size);
	game->e_tex = mlx_xpm_file_to_image(game->mlx, game->e_texture, &size, &size);
	game->w_tex = mlx_xpm_file_to_image(game->mlx, game->w_texture, &size, &size);
